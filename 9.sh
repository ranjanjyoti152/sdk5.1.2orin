...
sleep 0.5
safe_apt_install "sudo -E apt-get -y --allow-downgrades  install /opt/nvidia/deb_repos/nvidia-l4t-gstreamer_36.2.0-20231130105725_arm64.deb" 5
sleep 5
sudo rm -f /opt/nvidia/deb_repos/nvidia-l4t-gstreamer_36.2.0-20231130105725_arm64.deb
